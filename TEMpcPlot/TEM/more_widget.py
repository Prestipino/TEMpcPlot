...
class RectangleBuilder(AxesWidget):
    ...
    def line_callback(self, verts):
        ...
        self.width = 0.0
        self.Rleft = Rectangle(self.line.origin, self.width, self.line.mod, self.line.angle, color='r', alpha=0.3)
        self.Rright = Rectangle(self.line.origin, -self.width, self.line.mod, self.line.angle, color='r', alpha=0.3)
